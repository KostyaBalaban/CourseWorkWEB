...
const stripePromise = loadStripe("pk_test_51QT6w0QsTh878khAnVWtUgwgTsAsnUsisp6vEIXLK2NM2dcvXubgvOVYpVpbIWj6TiA5uMouuop6EpbsOPLQL33y00jicaayLJ");
const OrderSummary = () => {
		...
		>
            ...
            <motion.button
                ...
                <div className='flex items-center justify-center gap-2'>
					...
					<Link
						to='/'
						className='inline-flex items-center gap-2 text-sm font-medium text-cyan-400 underline hover:text-emerald-300 hover:no-underline'
					>
						Continue Shopping
						<MoveRight size={16} />
					</Link>
